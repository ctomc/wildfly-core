...
final class NodeSubregistry {
    ...
    NodeSubregistry(final String keyName, final ConcreteResourceRegistration parent, AccessConstraintUtilizationRegistry constraintUtilizationRegistry, CapabilityRegistry<CapabilityRegistration,RequirementRegistration> capabilityRegistry) {
