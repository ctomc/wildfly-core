...
/**
 * Runtime API for the JMX {@link org.jboss.as.controller.capability.RuntimeCapability}.
 *
...
public class JmxCapability {
     ...
     * the {@link javax.management.MBeanServer} provided by this capability.
     *
     * @return the service name. Will not be {@code null}
     */
    public ServiceName getMBeanServerServiceName() {
